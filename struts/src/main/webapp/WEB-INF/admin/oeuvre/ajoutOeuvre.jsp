...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><s:text name="admin.addLivre"/></li>
        </ol>
        <hr/>
    </section>
                    ...
                    <s:div cssClass="col-md-10 col-md-offset-0">
                        <s:div cssClass="panel panel-primary">
                            ...
                            <s:div cssClass="panel-body">
                                <s:form action="creerOeuvre" theme="simple" name="formulaire" id="formulaire">
                                    <s:div>
                                        Titre : <br/>
                                        <s:textfield name="titre" id="titre" placeholder="Titre" value="" onkeyup="verifOeuvre()" cssClass="col-md-12 input-higher"/>
                                    </s:div>
                                    <s:div>
                                        <br/>Auteur : <br/>
                                        <s:textfield name="auteur" id="auteur" placeholder="Auteur" value="" onkeyup="verifOeuvre()" cssClass="col-md-12 input-higher"/>
                                    </s:div>
                                    <s:div>
                                        <br/>
                                    ...
                                    <s:div>
                                        <br/>Quantité : <br/>
                                        <s:textfield type="number" name="quantite" placeholder="Quantité" value="1" step="1" min="1" cssClass="col-md-3"/>
                                    </s:div>
                                    ...
                                    <p class="col-md-offset-4">
                                        <s:div cssClass="input-group col-md-3">
                                            ...
                                            <span class="input-group-addon">
                                                <s:checkbox name="empruntable" value="true" id="empruntable"/>
                                            </span>
                                        </s:div>
                                    </p>
                                    <s:div>
